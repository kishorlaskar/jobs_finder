                    ...
                    <div class="client-post-job">
                        <div class="row">
                            <div class="col-md-8">
                               ...
                               <div class="col-md-2">
                                <a href="{{ route('archive_view_job_details',['name' => $job_list->id]) }}" class="works-btn-default">View Job</a>
                            </div>
                                </div>
                            </div>
                            <div class="col-md-2">
                              ...
                              <a href="{{ route('recomondation_id',['name' => $job_list->job_designation_id]) }}"><span style="background-color: red;color: white;margin-top: 10px;">&nbsp;Recomonded({{$designation[$job_list->job_designation_id]}})&nbsp;</span></a>
                                ...
                                <a style="margin-top: 40px; margin-left: 30%;" class="btn btn-success btn-edit" data-toggle="tooltip" data-placement="left" title="Edit" href="{{ route('archive_job_id',['name' => $job_list->id]) }}" ><i class="fa fa-pencil" aria-hidden="true"></i></a>
                            </div>
                            <div class="col-md-2">
                               ...
                               <a href="{{ route('apply_job_id',['name' => $job_list->id]) }}"><span style="background-color: red;color: white;margin-top: 10px;">&nbsp;Apply({{$Frequencys[$job_list->id]}})&nbsp;</span></a> </div>
                                ...
                                @endif
                                <form action="{{ route('archive_job_delete',['name' => $job_list->id]) }}" method="get" onsubmit="return confirm_delete()">
