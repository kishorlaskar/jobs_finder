              ...
              <div class="card card-plain">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <h4 style="color: #862FA0; display: inline-block;padding: 5px;">Job Designation Information</h4>
                    <div class="container-fluid">
                    <div class="row">
                    <div class="col-md-6">
                      ...
                      <tbody>
                       ...
                       <tr>
                         <td>{{$i}}</td>
                         <td>{{$job_designation->designation_name}}</td>
                       </tr>
                        @php $i++; @endphp
                        @endforeach
                      </tbody>
                    </table>
                    {{$job_designations->links()}}
                    </div>
                    <div class="col-md-1" style="border-left: thick solid #862FA0; height: 300px;"> 
                    </div>
                    <div class="col-md-4">
                      <h4 style="color: white; display: inline-block;padding: 5px;">Add Job Designation</h4><br><br>
                      <form>
