...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2018 at 10:18 PM
...
--
-- Table structure for table `academic_transcription`
--

CREATE TABLE `academic_transcription` (
  `id` int(11) NOT NULL,
  `candidate_email` varchar(254) NOT NULL,
  `transcription_name` varchar(254) NOT NULL,
  `transcript_file_ext` varchar(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `academic_transcription`
--

INSERT INTO `academic_transcription` (`id`, `candidate_email`, `transcription_name`, `transcript_file_ext`) VALUES
(5, 'mokbul@gmail.com', 'SSC', 'pdf');
...
(25, 'mokbul@gmail.com', 28, '2018-10-04', '04:57:40 am', 1),
(26, 'mokbul@gmail.com', 23, '2018-10-04', '04:58:15 am', 1),
(27, 'mokbul@gmail.com', 27, '2018-10-16', '04:37:21 am', 1);
...
INSERT INTO `company_city` (`id`, `city_name`) VALUES
(1, 'Dhaka'),
(2, 'Comilla'),
(3, 'Barisal'),
(4, 'Chittagong'),
...
(3, 2, 'gdffggd', 'dffgdhhh', 'gdfg', '20', '2018'),
...
CREATE TABLE `industry_types` (
  `id` int(11) NOT NULL,
  `industry_type_name` varchar(254) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `industry_types` (`id`, `industry_type_name`) VALUES
(1, 'Advertising Agencey'),
(2, 'Consumer goods'),
(3, 'Consumer services'),
(4, 'Conglomerates'),
(5, 'Oil & gas'),
...
INSERT INTO `jobholder_info` (`id`, `username`, `password`, `company_name`, `alternative_company_name`, `contact_person_designation`, `contact_person_phone`, `contact_person_email`, `business_description`, `company_address`, `company_country`, `company_city`, `company_area`, `billing_address`, `website_address`) VALUES
(1, 'company_email', '$2y$10$vuDuuANMy.rKZJ/lol4fwelcS5RvHKk1lo89Xt7W5MqZIgDsN/MAy', 'THESOFTKING.COM', 'ccc', 'ccc', '555', 'anik@gmail.com', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', 'ccc', 'bangladesh', 'comilla', 'arambag', NULL, 'www.google.com'),
(2, 'hhhhh', '$2y$10$avfZERkqf2BMNB8BimdYveicQR2qwb5kumwvnmT4ztu.xFIQcnDpC', 'hhhh', NULL, 'hhh', '888', 'mokbul@gmail.com', 'hhhhh', 'hhhh', 'bangladesh', 'dhaka', 'Agargaon', NULL, NULL),
(3, 'hjgjgh', '$2y$10$np6HMIlfkairXp7.BZORkuKEI0WGt3/EVSOBiAHpfJJ5RO4HwKrv.', 'fffffffffff', 'ffffffffffff', 'ffffffff', '4444444', 'mokbul@gmail.com', 'gggggggggg', 'ggggggg', 'pakistan', 'comilla', 'ashulia', NULL, NULL),
(4, 'jobholder@gmail.com', '$2y$10$vl8s/g1perTfM2soifwmmeh5ce.HqX4op39nwX6HkgU/8zQtSlyqS', 'FS IT', NULL, 'Admin', '1778207719', 'mokbul@gmail.com', 'IT Base ...', 'Comilla', 'bangladesh', 'dhaka', 'arambag', NULL, NULL),
(5, 'mmm', '$2y$10$EE9Llt1.fDfhv8/zsWbQUeoVsJlCnrczoveze4osJunkl0ieprSR6', 'mmm', 'mmm', 'mm', '66', 'mokbul@gmail.com', 'mmm', 'mmm', 'bangladesh', 'dhaka', 'arambag', NULL, NULL);
...
(2, 'mokbul@gmail.com', 'md mokbul', 'hossain', '$2y$10$odg1u.BPOBT4aynhsDb5AudlSdfRiwmARqHsATJWmezrKbR6SgzAC', 'md abul hossain', 'Golapi begum', '1995-03-22', 'Male', 'Islam', 'Single', 'Bangladehi', 'Saver,Ashulia,dhaka', 'Fulshore,Natore,Rajshahi,Bangladesh', '01778207719', 'mokbul15-469@gmail.com', 'public/uploaded_candidate_image/mokbul@gmail.com.jpg');
...
(59, 'Accountancy and financial management'),
(45, 'Agro (Plant/Animal/Fisheries)'),
(11, 'Back-End Developer'),
(46, 'Bank/ Non-Bank Fin. Institution'),
(50, 'Beauty Care/ Health & Fitness'),
(13, 'clenner'),
(48, 'Commercial/Supply Chain'),
(55, 'Data Entry/Operator/BPO'),
(51, 'Education/Training'),
(52, 'Electrician/ Construction/ Repair'),
(54, 'Engineer/Architects'),
(10, 'Front End Developer'),
(57, 'Graphic Designer'),
(42, 'Hospitality, leisure and travel'),
(47, 'Hospitality/ Travel/ Tourism '),
(12, 'IT & Telecommunication'),
(5, 'Laravel Developer'),
(9, 'manager'),
(44, 'Production/Operation'),
(49, 'Research/Consultancy'),
(53, 'Secretary/Receptionist'),
(56, 'Web Designer');
...
--
-- Dumping data for table `messanger`
--

INSERT INTO `messanger` (`id`, `sender_id`, `receiver_id`, `message`, `sending_date`, `sending_time`, `status`) VALUES
(1, 1, 2, 'hi', '2018-06-28', '16:12:23 pm', 1),
(2, 2, 1, 'hello bro', '2018-06-28', '17:12:23 pm', 1),
(3, 1, 2, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has s', '2018-06-29', '18:12:23 pm', 1),
(4, 2, 4, 'got to hell', '2018-06-29', '18:12:23 pm', 1);
...
INSERT INTO `project_info` (`id`, `jobseeker_id`, `project_name`, `project_discription`, `project_link`) VALUES
(1, 2, 'gdfgdfg', 'gdfgdfg', 'dfgdg');
...
(42, 'mokbul15-469@diu.edu.bd', '9'),
(43, 'mokbul15-469@diu.edu.bd', '5'),
(44, 'mokbul15-469@diu.edu.bd', '12'),
(53, 'mokbul@gmail.com', '11'),
(54, 'mokbul@gmail.com', '10'),
(55, 'mokbul@gmail.com', '53');
...
(6, 2, 'rrr', 'sds', 'sds', 'sdfskk', 'rrrr555oo99gtdf'),
(7, 2, 'vgdfvg', 'fgdg', 'dfgdf', 'fgf', 'dfg');
...
--
-- Indexes for table `academic_transcription`
--
ALTER TABLE `academic_transcription`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `academic_transcription`
--
ALTER TABLE `academic_transcription`
...
--
-- AUTO_INCREMENT for table `jobholder_info`
--
ALTER TABLE `jobholder_info`
...
--
ALTER TABLE `job_designation`
  MODIFY `id` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
-- AUTO_INCREMENT for table `messanger`
--
ALTER TABLE `messanger`
  MODIFY `id` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `recomonded_designation`
  MODIFY `id` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
